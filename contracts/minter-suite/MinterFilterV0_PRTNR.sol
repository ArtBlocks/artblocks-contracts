 ...
 * @dev functionally the same as flagship MinterFilter, but uses PBAB core
 * interface.
 * @author Art Blocks Inc.
 */
contract MinterFilterV0_PRTNR is IMinterFilterV0 {
    /**
     * @notice This minter is to be considered `_coreContractAddress`'s
     * canonical minter.
     * @dev may be vestigial after future core contract migrations
     */
    ...
    /// This contract only uses the portion of PBAB interface also on V1 core
