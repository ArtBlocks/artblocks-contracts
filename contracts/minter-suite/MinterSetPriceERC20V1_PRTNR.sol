...
contract MinterSetPriceERC20V1_PRTNR is ReentrancyGuard, IFilteredMinterV0 {
    ...
    // This type does **not** diverge from `MinterSetPriceERC20V1` despite the
    // `_PRTNR` addition, as the delta between these versions is purely an
    // implementation detail (in the payment splitting method) and does not
    // change the interface of the minter.
