...
import {SplitterLib} from "./SplitterLib.sol";
 ...
 */
// PROTOTYPE ONLY!
contract MinterSetPriceVLib is
    ReentrancyGuard,
    IFilteredMinterV2,
    IMinterBaseV0
{
    ...
    string public constant minterType = "MinterSetPriceVLib";
    ...
    constructor(
        ...
        SplitterLib.init(_genArt721Address);
    ...
    function isEngine() external view override returns (bool) {
        return SplitterLib.isEngine();
    }
