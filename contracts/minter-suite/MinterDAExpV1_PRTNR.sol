 ...
 */
contract MinterDAExpV1_PRTNR is ReentrancyGuard, IFilteredMinterV0 {
    ...
    /// This contract handles cores with interface IV2
    ...
    // This type does **not** diverge from `MinterDAExpV1` despite the `_PRTNR`
    // addition, as the delta between these versions is purely an implementation
    // detail (in the payment splitting method) and does not change the
    // interface of the minter.
