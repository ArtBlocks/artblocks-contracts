...
import type {
  IDelegationRegistry,
  IDelegationRegistryInterface,
} from "../IDelegationRegistry";
...
export class IDelegationRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): IDelegationRegistryInterface {
    return new utils.Interface(_abi) as IDelegationRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDelegationRegistry {
    return new Contract(address, _abi, signerOrProvider) as IDelegationRegistry;
  }
}
