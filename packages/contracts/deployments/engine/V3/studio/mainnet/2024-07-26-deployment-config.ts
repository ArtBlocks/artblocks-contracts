...
export const deployConfigDetailsArray = [
  {
    ...
    salt: "0x0000000000000000000000000000000000000000a73bf3db9deb910360000080",
    // INCREMENT THESE NUMBERS FOR EACH NEW STUDIO DEPLOYMENT
    tokenName: "Art Blocks Studio | 23",
    tokenTicker: "ABSTUDIO_23",
    // set to the address you want to transfer the superAdmin role to
    // (can be the zero address if you have an existing Admin ACL Contract and are not transferring)
    newSuperAdminAddress: "0xF128C0e35C19A3476A566E173c7AcB44e28181Fc",
