...
export const deployNetworkConfiguration = {
  ...
  transactionHash:
    "0x60e53f3df30162c96606f407fdb1edc8c686c185165d476fdef4f23143f4b80b",
};
...
export const deployConfigDetailsArray = [
  {
    ...
    // deploys to 0x00000096DF621F2A8EF2f103B7299b7910d8cD99
    salt: "0x000000000000000000000000000000000000000042bd5d61b050beae2b000010",
    // INCREMENT THESE NUMBERS FOR EACH NEW STUDIO DEPLOYMENT
    tokenName: "Art Blocks Studio | 111",
    tokenTicker: "ABSTUDIO_111",
  ...
  },
  {
    ...
    engineCoreContractType: 1,
    // salt from _FLEX_efficient_addresses_mainnet-delete-when-used.txt
    // deploys to 0x000000b2723b0B8523C12C286d36852B950b5fA6
    salt: "0x000000000000000000000000000000000000000042bd5d61b050683a46000006",
    // INCREMENT THESE NUMBERS FOR EACH NEW STUDIO DEPLOYMENT
    tokenName: "Art Blocks Studio | 112",
    tokenTicker: "ABSTUDIO_112",
    // optionally define this for improved readability and searchability in the deployment logs
