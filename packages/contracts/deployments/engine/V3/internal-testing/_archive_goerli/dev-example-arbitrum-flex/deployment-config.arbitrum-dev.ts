...
export const deployDetailsArray = [
  {
    ...
    engineRegistryAddress: "0x429af8eE97750aaddE1e8df9e921e11406ff9ed2",
    randomizerContractName: "BasicRandomizerV2",
    genArt721CoreContractName: "GenArt721CoreV3_Engine_Flex",
    tokenName: "Test Engine Partner Flex Arbitrum",
    tokenTicker: "DEV_EX_ARB_FLEX",
    startingProjectId: 0,
