...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Endaoment Gallery for Good",
    tokenTicker: "EGG",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "deployer", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xC121cdb13F4E67D5563beA5257f35B1609a4c423", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0xC121cdb13F4E67D5563beA5257f35B1609a4c423", // use either "0x..." or undefined if not transferring
