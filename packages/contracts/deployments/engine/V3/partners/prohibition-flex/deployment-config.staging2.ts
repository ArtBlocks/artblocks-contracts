...
export const deployDetailsArray = [
  {
    ...
    tokenName: "ProhibitionV1_1",
    tokenTicker: "PRB",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "deployer", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xC430CE0184e536e341e04dCE0f4C37895a92b809", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xC430CE0184e536e341e04dCE0f4C37895a92b809", // use either "0x..." or undefined if not transferring
