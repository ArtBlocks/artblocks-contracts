...
export const deployDetailsArray = [
  {
    ...
    renderProviderAddress: "0xD5AdDC3C9a587ba9f888e3164D3acd6535840Ee3", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xd71a0dB203af616F76b6AD24BD54eE46882FF175", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xd71a0dB203af616F76b6AD24BD54eE46882FF175", // use either "0x..." or undefined if not transferring
