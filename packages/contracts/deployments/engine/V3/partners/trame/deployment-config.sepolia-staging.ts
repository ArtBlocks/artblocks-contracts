...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "TRAMExCPG",
    tokenTicker: "TRAMECPG",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "deployer", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x4C7D8c95a0ABE647E36a8570136cAe0BaA5288af", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x4C7D8c95a0ABE647E36a8570136cAe0BaA5288af", // use either "0x..." or undefined if not transferring
