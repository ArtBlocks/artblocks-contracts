...
export const deployDetailsArray = [
  {
    ...
    tokenName: "Sothebys Gen Art",
    tokenTicker: "STBYS",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0xC786c3D630B57D48E399f8023bB0429375f1d22d", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x6E9cb366000470626Ee0b4103Dc9F77CcA19243B", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x6E9cb366000470626Ee0b4103Dc9F77CcA19243B", // use either "0x..." or undefined if not transferring
