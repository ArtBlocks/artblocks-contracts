...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0xfa37B5833F234540d45E675288EEf1F7D36506Ed", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xfa37B5833F234540d45E675288EEf1F7D36506Ed", // use either "0x..." or undefined if not transferring
