...
export const deployDetailsArray = [
  {
    ...
    renderProviderAddress: "0x29A96f721b2F9f4fb0d40791Ff4018471440aC72", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x2329FD5F1924b0d6Df643eeEA4Fbf816f415C879", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x2329FD5F1924b0d6Df643eeEA4Fbf816f415C879", // use either "0x..." or undefined if not transferring
