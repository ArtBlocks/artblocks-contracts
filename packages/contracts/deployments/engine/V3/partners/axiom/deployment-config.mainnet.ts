...
export const deployDetailsArray = [
  {
    ...
    tokenName: "Axiom Space3",
    tokenTicker: "AXIOM",
    startingProjectId: 34,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x27c914E3E5C4a008C3F04578323293DcAeE13B72", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x52dba55dd2b5de24f51efc6c57231c173e869fb9", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x52dba55dd2b5de24f51efc6c57231c173e869fb9", // use either "0x..." or undefined if not transferring
