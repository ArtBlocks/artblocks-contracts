...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0xbF826ed6D0F74278b81056C45e21928a374051ba", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xbF826ed6D0F74278b81056C45e21928a374051ba", // use either "0x..." or undefined if not transferring
