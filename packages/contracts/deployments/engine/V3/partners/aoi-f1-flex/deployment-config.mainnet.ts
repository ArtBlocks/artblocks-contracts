...
export const deployDetailsArray = [
  {
    ...
    tokenName: "AOI Engine",
    tokenTicker: "AOI",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0xd4F76BBd27168c7d9F2da881BF8CCBAB44e2Bd4a", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xD533F117a926244974ac2690145Ed04829e72a39", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xD533F117a926244974ac2690145Ed04829e72a39", // use either "0x..." or undefined if not transferring
