...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "The Disruptive Gallery",
    tokenTicker: "TDG",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x5B614c9C64B4c626E0302970DFA2FCde6F3B1A2b", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x7118b4e929b72Cb75C69C7CF4467fA7E2761175f", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x7118b4e929b72Cb75C69C7CF4467fA7E2761175f", // use either "0x..." or undefined if not transferring
