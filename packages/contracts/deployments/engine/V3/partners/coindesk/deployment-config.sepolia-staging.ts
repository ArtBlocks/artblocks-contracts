...
export const deployConfigDetailsArray = [
  {
    ...
    platformProviderAddress: "0x218162EA0AF740Ad3cCb50E7C15FBEe52CFDc6B3", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x218162EA0AF740Ad3cCb50E7C15FBEe52CFDc6B3", // use either "0x..." or undefined if not transferring
