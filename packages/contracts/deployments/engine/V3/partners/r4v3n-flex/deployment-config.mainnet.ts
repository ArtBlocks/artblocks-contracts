...
export const deployDetailsArray = [
  {
    ...
    tokenName: "r4v3n Art Blocks Engine",
    tokenTicker: "R4V3NABE",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "0x9D909728BF582196AB3612148B7C4Fe3c790d467", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xF2162BaCC9F76608bA4b11b1a6dac976ED463129", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xF2162BaCC9F76608bA4b11b1a6dac976ED463129", // use either "0x..." or undefined if not transferring
