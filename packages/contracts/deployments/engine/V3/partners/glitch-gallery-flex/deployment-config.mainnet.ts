...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "glitch Gallery",
    tokenTicker: "glitch",
    startingProjectId: 1,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x3c53D7bAdfAFB74D1C7c2b5ce9828C2bB023156F", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x6e2F6130B31df274283fb21744Ad18836aBCaceE", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x6e2F6130B31df274283fb21744Ad18836aBCaceE", // use either "0x..." or undefined if not transferring
