...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Light House",
    tokenTicker: "LIGHT",
    startingProjectId: 1,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x89151206E5bdf6284D3Bf01f7FdFed5A98750CBb", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x73D834090da6bD2F03f34C50840487BEF31e3Eca", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x73D834090da6bD2F03f34C50840487BEF31e3Eca", // use either "0x..." or undefined if not transferring
