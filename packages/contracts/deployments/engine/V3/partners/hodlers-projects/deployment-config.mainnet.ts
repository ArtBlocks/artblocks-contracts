...
// @dev ticket: https://github.com/ArtBlocks/artblocks/issues/547
export const deployDetailsArray = [
  {
    ...
    tokenName: "Hodlers Collector Pass",
    tokenTicker: "HODLERS",
    startingProjectId: 1,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0xbf4674ee0F5ab527eD187B32739b54B62aEB6247", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x8cc0019C16bced6891a96d32FF36FeAB4A663a40", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x8cc0019C16bced6891a96d32FF36FeAB4A663a40", // use either "0x..." or undefined if not transferring
