...
export const deployDetailsArray = [
  {
    ...
    renderProviderAddress: "0x800B30138d4651D1F5f545ad72FD43f3Eb61F7e6", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x5248a487092fda53A67adf050728012857ADDBC9", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x5248a487092fda53A67adf050728012857ADDBC9", // use either "0x..." or undefined if not transferring
