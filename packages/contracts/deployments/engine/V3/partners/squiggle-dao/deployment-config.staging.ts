...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0xc904Af16BeDe828A7e2728923CD72DA1F73Fe186", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xc904Af16BeDe828A7e2728923CD72DA1F73Fe186", // use either "0x..." or undefined if not transferring
