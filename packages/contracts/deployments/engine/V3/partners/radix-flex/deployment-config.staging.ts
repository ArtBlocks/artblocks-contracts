...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0x273E70Be4522Bf31F30F80310D5015a7A26C40BD", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x273E70Be4522Bf31F30F80310D5015a7A26C40BD", // use either "0x..." or undefined if not transferring
