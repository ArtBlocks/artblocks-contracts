...
export const deployNetworkConfiguration = {
  network: "base",
  // Please set to "dev", "staging", or "prod"
  environment: "prod",
  ...
  transactionHash:
    "0x2217456a2000f0c52b2a7c5f448d56b57d79d61c6afa227e09b83671e7b0d7d2",
};
...
export const deployConfigDetailsArray = [
  {
    ...
    // zero address as all revenue will go to render provider address
    ...
    // AB admin address
    newSuperAdminAddress: "0x437461553625d179A49c265258Fa71E442bBffEF",
    startingProjectId: 0,
    ...
    // since this is an Art Blocks project, all revenue will go to render provider address
    ...
    salt: "0x00000000000000000000000000000000000000008ffcfb849fbcde7740000080",
