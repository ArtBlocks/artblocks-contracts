...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0x29B2f895343CAdfB3f5101BEF6484B1F01c83Dc9", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x29B2f895343CAdfB3f5101BEF6484B1F01c83Dc9", // use either "0x..." or undefined if not transferring
