...
export const deployDetailsArray = [
  {
    ...
    renderProviderAddress: "0xA12a196e2A5662733BfBfF769D0e8e252d19DA7F", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xFf90F956C9A7d52aC21C37fe7a34801849887f19", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xFf90F956C9A7d52aC21C37fe7a34801849887f19", // use either "0x..." or undefined if not transferring
