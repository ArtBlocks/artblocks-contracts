...
export const deployConfigDetailsArray = [
  {
    ...
    platformProviderAddress: "0x38A0217478892db54992729eFC42d261e28bb82f", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x38A0217478892db54992729eFC42d261e28bb82f", // use either "0x..." or undefined if not transferring
