...
export const deployConfigDetailsArray = [
  {
    ...
    renderProviderAddress: "0x17f414ead987Bc84D0f4dbafA3aEdEa73fea9C30", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x71fE505119c43b5c5812E1c1197876976e3a05aE", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x71fE505119c43b5c5812E1c1197876976e3a05aE", // use either "0x..." or undefined if not transferring
