...
export const deployDetailsArray = [
  {
    ...
    tokenName: "Elsewhere",
    tokenTicker: "Elsewhere",
    startingProjectId: 1,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x2aa7260dd2dA386a2Ab83d90E7206fF56EDDCb65", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x80bd64eF997f5D756f2Ec0f5E2edF7141317907F", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x80bd64eF997f5D756f2Ec0f5E2edF7141317907F", // use either "0x..." or undefined if not transferring
