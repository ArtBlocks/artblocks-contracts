...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Colors And Shapes",
    tokenTicker: "COLOR",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "deployer", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x7f5a0A6847fD0FA05C13CBC02f435047b429E37C", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x7f5a0A6847fD0FA05C13CBC02f435047b429E37C", // use either "0x..." or undefined if not transferring
