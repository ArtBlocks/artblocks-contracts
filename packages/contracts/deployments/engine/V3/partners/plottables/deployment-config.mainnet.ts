...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Plottables",
    tokenTicker: "PLOTS",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x497702b81Ffc3Aa3535c84Af86Cfb5a8b367E1b2", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x9f75C11383f5b93a72c61fb1Dd1a44f5Ec7e4187", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x9f75C11383f5b93a72c61fb1Dd1a44f5Ec7e4187", // use either "0x..." or undefined if not transferring
