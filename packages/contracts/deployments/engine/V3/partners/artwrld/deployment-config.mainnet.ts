...
export const deployDetailsArray = [
  {
    ...
    renderProviderAddress: "0xFc7C0b521ed8397E4625842eb00828c1A56f2ac1", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xb24EDdc13d67FEa233D3810f7A2426ACAa0AC105", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xb24EDdc13d67FEa233D3810f7A2426ACAa0AC105", // use either "0x..." or undefined if not transferring
