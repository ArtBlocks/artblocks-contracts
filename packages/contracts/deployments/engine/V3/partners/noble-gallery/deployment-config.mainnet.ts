...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Noble Generative",
    tokenTicker: "NGEN",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x3f71770894bD542c8e6e227FcFbeb4455A550DDa", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xf8e90D2D2f6f67A13D0a04374e22624A80a1e918", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0xf8e90D2D2f6f67A13D0a04374e22624A80a1e918", // use either "0x..." or undefined if not transferring
