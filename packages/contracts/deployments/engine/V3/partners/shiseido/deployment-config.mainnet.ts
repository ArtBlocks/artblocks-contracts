...
export const deployDetailsArray = [
  {
    ...
    renderProviderAddress: "deployer", // use either "0x..." or special "deployer" which sets the render provider to the deployer | NOTE: intentionally set to deployer at time of deployment, with follow-on action to set up render provider payment wallet.
    platformProviderAddress: "0x0E63aF41ebdB6FF4C37530Dde4757ABBFE3a2dF5", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x0E63aF41ebdB6FF4C37530Dde4757ABBFE3a2dF5", // use either "0x..." or undefined if not transferring
