...
export const deployConfigDetailsArray = [
  {
    ...
    platformProviderAddress: "0x011d3916eacD74Edc8C55c2C8085B3eA45963Fc8", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0x011d3916eacD74Edc8C55c2C8085B3eA45963Fc8", // use either "0x..." or undefined if not transferring
