...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0x97FD319E3d5283296583035C5AdDef1e99e21a2E", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x97FD319E3d5283296583035C5AdDef1e99e21a2E", // use either "0x..." or undefined if not transferring
