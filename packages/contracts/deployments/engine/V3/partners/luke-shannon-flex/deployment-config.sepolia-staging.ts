...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Luke Shannon",
    tokenTicker: "LUKE",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "deployer", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xc7D7852C8936CFfd7903e07CE0758527C4b3e9a1", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0xc7D7852C8936CFfd7903e07CE0758527C4b3e9a1", // use either "0x..." or undefined if not transferring
