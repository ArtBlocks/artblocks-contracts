...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Legends of Metaterra PBAB",
    tokenTicker: "LOM",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "deployer", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xe18Fc96ba325Ef22746aDA9A82d521845a2c16f8", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0xe18Fc96ba325Ef22746aDA9A82d521845a2c16f8", // use either "0x..." or undefined if not transferring
