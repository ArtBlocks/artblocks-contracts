...
export const deployConfigDetailsArray = [
  {
    ...
    tokenName: "Bright Moments Finale",
    tokenTicker: "FINALE",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: true,
    renderProviderAddress: "0x43A7D26a271F5801b8092d94DFd5b36EA5D01F5f", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0xB96E81f80b3AEEf65CB6d0E280b15FD5DBE71937", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0xB96E81f80b3AEEf65CB6d0E280b15FD5DBE71937", // use either "0x..." or undefined if not transferring
