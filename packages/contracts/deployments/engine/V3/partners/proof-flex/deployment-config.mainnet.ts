...
// @dev ticket: https://github.com/ArtBlocks/artblocks/issues/541
export const deployDetailsArray = [
  {
    ...
    minters: [
      ...
      // @dev this is intentionally left blank, as PROOF will deploy their own minter contract(s)
    ],
    ...
    newSuperAdminAddress: "0x32220f07DBcd18149f619F28cD09FD911cc0372D", // use either "0x..." or undefined if not transferring
