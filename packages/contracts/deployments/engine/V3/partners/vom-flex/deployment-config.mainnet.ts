...
export const deployDetailsArray = [
  {
    ...
    tokenName: "Venus Over Manhattan",
    tokenTicker: "VENUS",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0x9F84c01aDc7bd771122a99a61b26d6a8095C7Db6", // use either "0x..." or special "deployer" which sets the render provider to the deployer
