...
export const deployDetailsArray = [
  {
    ...
    tokenName: "Vertical Gen Art",
    tokenTicker: "VGEN",
    startingProjectId: 0,
    autoApproveArtistSplitProposals: false,
    renderProviderAddress: "0xA55B7B2eb2565280cacF4C5DD9cBd775bB8dDafb", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    platformProviderAddress: "0x65FEca334780160e3420B097590fd6D02dE663f0", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x65FEca334780160e3420B097590fd6D02dE663f0", // use either "0x..." or undefined if not transferring
