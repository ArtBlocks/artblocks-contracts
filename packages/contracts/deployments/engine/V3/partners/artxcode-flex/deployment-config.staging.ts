...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0xC3989DDDae38f59510bAf51A65EC7d1D3dE0A17e", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xC3989DDDae38f59510bAf51A65EC7d1D3dE0A17e", // use either "0x..." or undefined if not transferring
