...
export const deployConfigDetailsArray = [
  {
    ...
    platformProviderAddress: "0xe19a6C81BE025dDdC209764a18A3fdcd71253d7D", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    ...
    newSuperAdminAddress: "0xe19a6c81be025dddc209764a18a3fdcd71253d7d", // use either "0x..." or undefined if not transferring
