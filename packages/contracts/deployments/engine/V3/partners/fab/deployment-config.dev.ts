...
// @dev ticket: https://github.com/ArtBlocks/artblocks/issues/533
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0xbeDF910B5cc587eE6633855080CAd1Ed08B8bF8e", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0xbeDF910B5cc587eE6633855080CAd1Ed08B8bF8e", // use either "0x..." or undefined if not transferring
