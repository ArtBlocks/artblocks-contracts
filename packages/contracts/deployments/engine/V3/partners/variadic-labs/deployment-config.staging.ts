...
export const deployDetailsArray = [
  {
    ...
    platformProviderAddress: "0x61F1Ca3F65EA947B01bC66379bc4a7C5a07a8A3F", // use either "0x..." or special "deployer" which sets the render provider to the deployer
    // minter suite
    ...
    newSuperAdminAddress: "0x61F1Ca3F65EA947B01bC66379bc4a7C5a07a8A3F", // use either "0x..." or undefined if not transferring
