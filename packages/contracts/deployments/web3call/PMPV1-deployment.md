...
> ⚠️ The initcodeHash changes if PMPV1's bytecode changes (e.g. the addition of `pmpType()`).
> Always regenerate the hash from the current build before mining a salt or deploying.
