...
/**
 * This script deploys the SRHooks contract on Mainnet.
...
const OWNER_ADDRESS = "0x52119BB73Ac8bdbE59aF0EEdFd4E4Ee6887Ed2EA";
...
const CORE_CONTRACT_ADDRESS = "0xAbaBabABAb20053426aD1C782de9ea8444358070";

// Project ID - the specific project on the core contract that this hooks contract is for
const CORE_PROJECT_ID = 5;

// Expected network
const EXPECTED_NETWORK = "homestead";
...
async function main() {
  ...
  console.log("SRHooks Deployment Script - Mainnet Production");
  console.log(
    "================================================================================"
  );
  console.log("");
  ...
  try {
    ...
    if (e.message.includes("Already Verified")) {
      ...
      console.log(
        `npx hardhat verify --network mainnet ${implementationAddress}`
      );
    }
  }
  ...
  console.log(
    `  Implementation: https://etherscan.io/address/${implementationAddress}`
  );
