...
//////////////////////////////////////////////////////////////////////////////
// FLEX contract file
import { GenArt721CoreV2ABTestFlex__factory } from "../../contracts/factories/GenArt721CoreV2ABTestFlex__factory";
import { GenArt721MinterABTestFlex__factory } from "../../contracts/factories/GenArt721MinterABTestFlex__factory";

// Details pulled from https://github.com/ArtBlocks/artblocks/issues/396 (private repo)
const tokenName = "Art Blocks FLEX Engine Test";
const tokenTicker = "ABEFLEX-TEST";
...
async function main() {
  ...
  const coreFactory = new GenArt721CoreV2ABTestFlex__factory(deployer);
  ...
  const genArt721MinterFactory = new GenArt721MinterABTestFlex__factory(
    deployer
  );
