...
//////////////////////////////////////////////////////////////////////////////
// contract file
import { GenArt721CoreV2FoundationForArt__factory } from "../../contracts/factories/GenArt721CoreV2FoundationForArt__factory";
import { GenArt721MinterFoundationForArt__factory } from "../../contracts/factories/GenArt721MinterFoundationForArt__factory";

// Details pulled from https://github.com/ArtBlocks/artblocks/issues/385 (private repo)
const tokenName = "fab DAO";
const tokenTicker = "FAB";
const transferAddress = "0x0F3Fe3d8607cDeC4FB76DE84F68713f6E0cd54Ac";
...
async function main() {
  ...
  const coreFactory = new GenArt721CoreV2FoundationForArt__factory(deployer);
  ...
  const genArt721MinterFactory = new GenArt721MinterFoundationForArt__factory(
    deployer
  );
