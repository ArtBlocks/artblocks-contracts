...
// CONFIG BEGINS HERE
//////////////////////////////////////////////////////////////////////////////
const pbabTokenName = "Doodle Labs Gen Art";
const pbabTokenTicker = "DOODLE";
const pbabTransferAddress = "0x95DcB7b8e99B7B8FCb1DCb9e82Bb12183b2bbE02";
...
async function main() {
  ...
  console.log(
    `${standardVerify} --network ${network.name} ${genArt721Core.address} "${pbabTokenName}" "${pbabTokenTicker}" ${randomizerContractAddress}`
  );
