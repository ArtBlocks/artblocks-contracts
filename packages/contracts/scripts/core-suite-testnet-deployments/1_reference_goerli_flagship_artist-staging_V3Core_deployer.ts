...
// CONFIG BEGINS HERE
//////////////////////////////////////////////////////////////////////////////
const tokenName = "Art Blocks V3 Core Staging (Goerli)";
const tokenTicker = "BLOCKS_V3_CORE_STAGING_GOERLI";
...
const startingProjectId = 120; // offset from existing V1 core with margin for maybe some new projects
