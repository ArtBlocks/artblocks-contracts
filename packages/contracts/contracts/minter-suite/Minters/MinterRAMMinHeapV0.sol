...
import {ISharedMinterRAMV0} from "../../interfaces/v0.8.x/ISharedMinterRAMMinHeapV0.sol";
 ...
 */
contract MinterRAMMinHeapV0 is
    ReentrancyGuard,
    ISharedMinterV0,
    ISharedMinterRAMV0
{
    ...
    string public constant minterType = "MinterRAMMinHeapV0";
