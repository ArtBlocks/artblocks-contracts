...
/**
 * @dev Forked version of the OpenZeppelin v4.7.1 ERC721 contract. Updated
 ...
 * {ERC721Enumerable}.
 */
contract ERC721_PackedHashSeedV1 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721_PackedHashSeedV1.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(
            ERC721_PackedHashSeedV1.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721_PackedHashSeedV1.ownerOf(tokenId), to, tokenId);
    }
