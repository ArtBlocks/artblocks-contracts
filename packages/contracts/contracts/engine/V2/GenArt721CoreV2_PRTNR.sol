...
import "../../interfaces/v0.8.x/IGenArt721CoreContractV1.sol";
...
/**
 * @title Art Blocks Partnership ERC-721 core contract.
    ...
    IGenArt721CoreContractV1
{
    ...
    address
        public
        override(IGenArt721CoreContractV1, IGenArt721CoreV2_PBAB) admin;
    ...
    function mint(
        ...
        external
        override(IGenArt721CoreContractV1, IGenArt721CoreV2_PBAB)
    ...
    /**
     * @notice Returns Art Blocks payment address.
     * @dev shim to conform to `IGenArt721CoreContractV1`
     */
    function artblocksAddress() external view returns (address payable) {
        return renderProviderAddress;
    }

    /**
     * @notice Returns percentage of mint revenue allocated to Art Blocks.
     * @dev shim to conform to `IGenArt721CoreContractV1`
     */
    function artblocksPercentage() external view returns (uint256) {
        return renderProviderPercentage;
    }
