...
interface T_ReaderTest_Config extends T_Config {
  ...
  versionedReader: BytecodeStorageReaderContractV2;
...
/**
 * Tests for BytecodeStorageReaderContractV2.
...
for (const coreContractName of coreContractsToTest) {
  describe(`${coreContractName} BytecodeStorageReaderContractV2`, async function () {
