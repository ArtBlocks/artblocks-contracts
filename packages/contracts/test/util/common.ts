...
export const PROJECT_UPDATED_FIELDS = {
  ...
  FIELD_PROJECT_TRANSFER_HOOK: ethers.utils.hexZeroPad(
    ethers.utils.hexlify(17),
    32
  ),
  FIELD_PROJECT_TRANSFER_HOOK_LOCKED: ethers.utils.hexZeroPad(
    ethers.utils.hexlify(18),
    32
  ),
};
