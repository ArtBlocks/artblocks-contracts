...
async function main() {
  ...
  console.log("Deploying GEN ART 721 Bonus from:", deployerAddress);
  ...
  const genArt721Bonus = await GenArt721Bonus.deploy(
    erc20Address,
    minterAddress,
    bonusValueInWei
  );
  ...
  console.log(
    "GenArt721 Bonus contract deployed at:",
    (await genArt721Bonus.deployed()).address
  );
}
