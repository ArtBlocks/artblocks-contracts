...
//////////////////////////////////////////////////////////////////////////////
// FLEX contract file
import { GenArt721CoreV2GencloFlex__factory } from "../../contracts/factories/GenArt721CoreV2GencloFlex__factory";
import { GenArt721MinterGencloFlex__factory } from "../../contracts/factories/GenArt721MinterGencloFlex__factory";

// Details pulled from https://github.com/ArtBlocks/artblocks/issues/275 (private repo)
const tokenName = "Generative Clothing";
const tokenTicker = "GENCLO";
const transferAddress = "0xAccBee638FEdFe3650be1FA3182b428483DB8369";
...
async function main() {
  ...
  const coreFactory = new GenArt721CoreV2GencloFlex__factory(deployer);
  ...
  const genArt721MinterFactory = new GenArt721MinterGencloFlex__factory(
    deployer
  );
