...
//////////////////////////////////////////////////////////////////////////////
// contract file
import { GenArt721CoreV2Tender__factory } from "../../contracts/factories/GenArt721CoreV2Tender__factory";
import { GenArt721MinterTender__factory } from "../../contracts/factories/GenArt721MinterTender__factory";

// Details pulled from https://github.com/ArtBlocks/artblocks/issues/370 (private repo)
const tokenName = "Tender";
const tokenTicker = "TENDER";
const transferAddress = "0xFdc45dae01d1F9EF394b33c227BA9489795d148B";
...
async function main() {
  ...
  const coreFactory = new GenArt721CoreV2Tender__factory(deployer);
  ...
  const genArt721MinterFactory = new GenArt721MinterTender__factory(deployer);
