...
//////////////////////////////////////////////////////////////////////////////
// FLEX contract file
import { GenArt721CoreV2EndaomentGalleryForGoodFlex__factory } from "../../contracts/factories/GenArt721CoreV2EndaomentGalleryForGoodFlex__factory";
import { GenArt721MinterEndaomentGalleryForGoodFlex__factory } from "../../contracts/factories/GenArt721MinterEndaomentGalleryForGoodFlex__factory";

// Details pulled from https://github.com/ArtBlocks/artblocks/issues/275 (private repo)
const tokenName = "Endaoment Gallery for Good - Flex";
const tokenTicker = "EGGFLEX";
const transferAddress = "0xbe21e4cf884c8b2517e4e199487f8b505841cb36";
const artblocksAddress = "0xb0E0e09dAe6b87e55f66043bf72E348Bdb4435d8";
...
async function main() {
  ...
  const coreFactory = new GenArt721CoreV2EndaomentGalleryForGoodFlex__factory(
    deployer
  );
  ...
  const genArt721MinterFactory =
    new GenArt721MinterEndaomentGalleryForGoodFlex__factory(deployer);
