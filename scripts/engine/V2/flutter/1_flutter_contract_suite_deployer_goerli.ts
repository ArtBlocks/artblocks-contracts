...
const pbabTransferAddress = "0xcA04E939A0Ac0626C4a4299735e353E8DC5eF3eC";
...
async function main() {
  ...
  console.log(
    `${standardVerify} --network ${network.name} ${genArt721Core.address} "${pbabTokenName}" "${pbabTokenTicker}" ${randomizerAddress}`
  );
