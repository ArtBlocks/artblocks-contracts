...
// CONFIG BEGINS HERE
//////////////////////////////////////////////////////////////////////////////
const pbabTokenName = "Colors and Shapes";
const pbabTokenTicker = "COLOR";
const pbabTransferAddress = "0x7f5a0A6847fD0FA05C13CBC02f435047b429E37C";
...
async function main() {
  ...
  const genArt721CoreFactory = new GenArt721CoreV2ColorsAndShapes__factory(
    deployer
  );
  ...
  const genArt721MinterFactory = new GenArt721MinterColorsAndShapes__factory(
    deployer
  );
