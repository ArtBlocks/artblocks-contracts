...
interface GenArt721Minter2BAKInterface extends ethers.utils.Interface {
  functions: {
    ...
    "minterCount(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "minterCount", values: [string]): string;
  encodeFunctionData(
...
export class GenArt721Minter2BAK extends Contract {
  ...
  interface: GenArt721Minter2BAKInterface;
  ...
  functions: {
    ...
    minterCount(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
