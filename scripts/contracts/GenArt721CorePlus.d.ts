...
interface GenArt721CorePlusInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "PlatformUpdated(string)": EventFragment;
    "PlatformWhitelistUpdated(string,address)": EventFragment;
    "ProjectAdded(uint256,address,string,string,uint256,bool,bool,bool,uint256)": EventFragment;
    "ProjectUpdated(uint256,string)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "PlatformWhitelistUpdated"): EventFragment;
...
export class GenArt721CorePlus extends Contract {
  ...
  interface: GenArt721CorePlusInterface;
  ...
  filters: {
    ...
    PlatformUpdated(field: null): TypedEventFilter<[string], { field: string }>;

    PlatformWhitelistUpdated(
      update: null,
      addr: null
    ): TypedEventFilter<[string, string], { update: string; addr: string }>;
