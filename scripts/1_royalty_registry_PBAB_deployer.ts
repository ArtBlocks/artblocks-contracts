...
async function main() {
  ...
  function getRoyaltyAddress(networkName: string, contract: string): string {
    ...
    if (networkName == "ropsten") {
      return contract === 'registry' ? "0x9cac159ec266E76ed7377b801f3b5d2cC7bcf40d" : "0xFf5A6F7f36764aAD301B7C9E85A5277614Df5E26"
    }
    if (networkName == "rinkeby") {
      return contract === 'registry' ? "0xc9198CbbB57708CF31e0caBCe963c98e60d333c3" : "0x8d17687ea9a6bb6efA24ec11DcFab01661b2ddcd"
    }
    if (networkName == "mainnet") {
      return contract === 'registry' ? "0xaD2184FB5DBcfC05d8f056542fB25b04fa32A95D" : "0X0385603AB55642CB4DD5DE3AE9E306809991804F"
    }
    return;
  }
  ...
  await coreTokenPBAB.connect(deployer).addProject("test_project", deployer.address, ethers.utils.parseEther("0.10"), { gasLimit: 500000 });
  await coreTokenPBAB.connect(deployer).updateProjectSecondaryMarketRoyaltyPercentage(0, 5, { gasLimit: 500000 });
  await coreTokenPBAB.connect(deployer).updateProjectAdditionalPayeeInfo(0, "0x24CdEE54439D3f25DE4cddE43e41B19FdAA90cE8", 20, { gasLimit: 500000 });

  await coreTokenPBAB.connect(deployer).toggleProjectIsActive(0, { gasLimit: 500000 });
  ...
  // set platform royalty payment address
    ...
    const token = await genArt721MinterPBAB.connect(deployer).purchase(0, { value: ethers.utils.parseEther("0.10"), gasLimit: 50000 });
